...
One of the common problems people new to strategy experience when trying to create one is trying to solve too many problems in one document. The solution is to recognise that strategies don't exist in isolation.
