...
There is no debate. There is no better time to upgrade software, resolve vulnerabilities, optimise infrastructure and actively manage the tests and the test runs than right now. Putting these hygiene tasks off, even for a day, is never to the organisation’s advantage.
...
Just getting these people out of their usual environments and associated with a new team will require negotiation with three director level people. Then the people themselves have to understand the new context they are working within and establish new ways of working. This sort of initiative requires much more frequent communication aimed at several different types of stakeholder than a usual team would require.

All of these hurdles stand in the way of bringing the utmost use of force to solving a problem in a modern organisation. If people and their capabilities are organised in such a way that it requires negotiation to bring their full capability to bear on a problem then the organisation’s structure has been optimised for something other than solving problems.
...
Any strategist, principal engineer or architect who has tried to help an organisation with a technology stack that is 10 years old or older can probably imagine the friction that Clauswitz saw in war.
